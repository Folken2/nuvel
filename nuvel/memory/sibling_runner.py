"""
Fire-and-forget sibling-agent runner for the meta-agent.
...
Mirror of the generated-agent ``sibling_runner`` for the meta-agent.
"""
...
# chain (nuvel/plugins/__init__.py) so ADK drives its close() at shutdown.
