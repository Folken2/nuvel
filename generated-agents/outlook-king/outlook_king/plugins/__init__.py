...
PLUGIN_PATHS = [
    "outlook_king.plugins.memory",
    "outlook_king.plugins.cost_guard",
    "outlook_king.plugins.trace",
    "outlook_king.plugins.context_filter",
    "outlook_king.plugins.console_logger",
    "outlook_king.plugins.tool_events",
    "outlook_king.plugins.resilience",
    "outlook_king.plugins.cache",
    "outlook_king.plugins.self_healing",
    "outlook_king.plugins.save_files",
    "outlook_king.plugins.recordings",
    "outlook_king.plugins.replay",
    "outlook_king.plugins.skill_curator",
]
