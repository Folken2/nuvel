...
from outlook_king.plugins import PLUGIN_PATHS
from outlook_king.config.logging import setup_logging, generate_request_id, request_id_var
...
# ── Plugin Chain ─────────────────────────────────────────────────────
# Plugins are pre-configured instances in outlook_king.plugins.
...
def main() -> None:
    ...
    if streaming_enabled:
        ...
        from outlook_king.streaming import mount_streaming
        from outlook_king.agent import root_agent
        from outlook_king.config.llm import LIVE_MODEL

        app = FastAPI(title="outlook-king")
    ...
    from outlook_king.cron.routes import router as cron_router
    from outlook_king.cron import scheduler as cron_scheduler
