...
from ppt_king.plugins import PLUGIN_PATHS
from ppt_king.config.logging import setup_logging, generate_request_id, request_id_var
...
# ── Plugin Chain ─────────────────────────────────────────────────────
# Plugins are pre-configured instances in ppt_king.plugins.
...
def main() -> None:
    ...
    if streaming_enabled:
        ...
        from ppt_king.streaming import mount_streaming
        from ppt_king.agent import root_agent
        from ppt_king.config.llm import LIVE_MODEL

        app = FastAPI(title="ppt-king")
    ...
    from ppt_king.cron.routes import router as cron_router
    from ppt_king.cron import scheduler as cron_scheduler
