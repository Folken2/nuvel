...
PLUGIN_PATHS = [
    "ppt_king.plugins.memory",
    "ppt_king.plugins.cost_guard",
    "ppt_king.plugins.trace",
    "ppt_king.plugins.context_filter",
    "ppt_king.plugins.console_logger",
    "ppt_king.plugins.tool_events",
    "ppt_king.plugins.resilience",
    "ppt_king.plugins.cache",
    "ppt_king.plugins.self_healing",
    "ppt_king.plugins.save_files",
    "ppt_king.plugins.recordings",
    "ppt_king.plugins.replay",
    "ppt_king.plugins.skill_curator",
]
