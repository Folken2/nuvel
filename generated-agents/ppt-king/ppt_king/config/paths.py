...
Env vars:
    SOUL_FILE       path to SOUL.md         (default: ppt_king/soul/SOUL.md)
    AWAKENING_FILE  path to AWAKENING.md   (default: ppt_king/soul/AWAKENING.md, persona only)
    SKILLS_DIR      path to skills/         (default: ppt_king/skills/)
...
_PKG = Path(__file__).parent.parent  # ppt_king/
