...
from word_king.plugins import PLUGIN_PATHS
from word_king.config.logging import setup_logging, generate_request_id, request_id_var
...
# ── Plugin Chain ─────────────────────────────────────────────────────
# Plugins are pre-configured instances in word_king.plugins.
...
def main() -> None:
    ...
    if streaming_enabled:
        ...
        from word_king.streaming import mount_streaming
        from word_king.agent import root_agent
        from word_king.config.llm import LIVE_MODEL

        app = FastAPI(title="word-king")
    ...
    from word_king.cron.routes import router as cron_router
    from word_king.cron import scheduler as cron_scheduler
