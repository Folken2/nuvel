...
Env vars:
    SOUL_FILE       path to SOUL.md         (default: word_king/soul/SOUL.md)
    AWAKENING_FILE  path to AWAKENING.md   (default: word_king/soul/AWAKENING.md, persona only)
    SKILLS_DIR      path to skills/         (default: word_king/skills/)
...
_PKG = Path(__file__).parent.parent  # word_king/
