...
PLUGIN_PATHS = [
    "word_king.plugins.memory",
    "word_king.plugins.cost_guard",
    "word_king.plugins.trace",
    "word_king.plugins.context_filter",
    "word_king.plugins.console_logger",
    "word_king.plugins.tool_events",
    "word_king.plugins.resilience",
    "word_king.plugins.cache",
    "word_king.plugins.self_healing",
    "word_king.plugins.save_files",
    "word_king.plugins.recordings",
    "word_king.plugins.replay",
    "word_king.plugins.skill_curator",
]
