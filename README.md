...
| `nuvel eval replay <name> [--agent <name>] [--since 7d] [--max-cost-usd N] [--concurrency N] [--force] [--dry-run]` | Replay a config variant against historical traces and score each replay with the judge/rubric |
